...
export default Backbone.Model.extend({
  defaults: {
    ...
    tileLayerOptions: {
      attribution: '&copy; <a href="http://www.openstreetmap.org/copyright">OpenStreetMap</a> | &copy; <a href="https://carto.com/attributions">CARTO</a> | <a href="/de/pages/quellen" data-module="page">' + i18n('sources') + '</a>',
    },
